...
| `base/` | Shared models, utilities, and middleware |
| `models/` | Django ORM models (may also live inside sub-apps) |
| `forms/` | Django forms and validators |
| `control/` | Organiser/back-office views |
| `presale/` | Attendee-facing (ticket purchase) views |
| `common/` | Cross-cutting helpers shared across modules |
| `config/` | Application configuration and settings |
| `plugins/` | Plugin infrastructure |
| `static/` | Static assets (CSS, JS, images) |
| `templates/` / `jinja-templates/` | HTML templates |
...
- **Add a form** → `app/eventyay/forms/` or `app/eventyay/<sub-app>/forms.py`
