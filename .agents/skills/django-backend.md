...
│   ├── base/           # Shared models, managers, middleware
│   ├── models/         # Additional/aggregated model definitions
│   ├── forms/          # Django forms and field validators
│   ├── control/        # Organiser back-office views and URLs
│   ├── presale/        # Attendee-facing views and URLs
...
- Form classes live in `app/eventyay/forms/` or alongside their sub-app.
